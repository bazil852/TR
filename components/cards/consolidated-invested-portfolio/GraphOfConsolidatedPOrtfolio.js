  ...
  return (
    ...
    >
      {dataWithWorth.map((item, index) => {
        ...
        const startX = 18 + radius * Math.cos(((start - 90) * Math.PI) / 180);
        const startY = 18 + radius * Math.sin(((start - 90) * Math.PI) / 180);
        const endX = 18 + radius * Math.cos(((end - 90) * Math.PI) / 180);
        const endY = 18 + radius * Math.sin(((end - 90) * Math.PI) / 180);

        const centerX =
          18 +
          radius * Math.cos(((start + percentage * 180 - 90) * Math.PI) / 180);
        const centerY =
          18 +
          radius * Math.sin(((start + percentage * 180 - 90) * Math.PI) / 180);
        const midX =
          18 +
          (radius + 2) *
